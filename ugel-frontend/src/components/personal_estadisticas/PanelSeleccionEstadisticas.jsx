import { BarChart, Clock, UserX, MapPin, Users } from 'lucide-react';

const PanelSeleccionEstadisticas = ({ categoriaActiva, onCategoriaChange }) => {
  const categorias = [
    {
      id: 'total-asistencias',
    ...
    {
      id: 'puntualidad',
      titulo: 'Puntualidad y Tardanzas',
      descripcion: 'Distribución de puntualidad',
      icono: Clock
    },
    {
      id: 'ausencias',
    ...
    {
      id: 'areas',
      titulo: 'Áreas / Dependencias',
      descripcion: 'Asistencia por área de trabajo',
      icono: MapPin
    },
    {
      id: 'personal',
      titulo: 'Personal',
      descripcion: 'Resumen por colaborador',
      icono: Users
    }
  ];
